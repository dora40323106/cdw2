...
ag1_40323106 = Blueprint('ag1_40323106', __name__, url_prefix='/ag1_40323106', template_folder='templates')

# 展示傳回 Brython 程式
@ag1_40323106.route('/task1')
def task1():
    outstring = '''
<!DOCTYPE html>
<html>
