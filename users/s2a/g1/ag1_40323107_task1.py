...
ag1_40323107 = Blueprint('ag1_40323107', __name__, url_prefix='/ag1_40323107', template_folder='templates')

# 展示傳回 Brython 程式
@ag1_40323107.route('/task1')
def task1():
    outstring = '''
<!DOCTYPE html>
<html>
